package com.szaporozhets.ktornoteapp.adapters
...
import com.szaporozhets.ktornoteapp.databinding.ItemNoteBinding
    ...
    override fun onBindViewHolder(holder: NoteViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            if (!note.isSynced) {
                ...
                binding.tvSynced.text = "Not Synced"
            } else {
                binding.ivSynced.setImageResource(R.drawable.ic_check)
                binding.tvSynced.text = "Synced"
            }
